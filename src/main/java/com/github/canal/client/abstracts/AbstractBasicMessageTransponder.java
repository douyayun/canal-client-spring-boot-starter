package com.github.canal.client.abstracts;

import com.alibaba.otter.canal.client.CanalConnector;
import com.alibaba.otter.canal.protocol.CanalEntry;
import com.alibaba.otter.canal.protocol.Message;
import com.github.canal.annotation.ListenPoint;
import com.github.canal.client.core.CanalMsg;
import com.github.canal.client.core.ListenerPoint;
import com.github.canal.client.exception.CanalClientException;
...
public abstract class AbstractBasicMessageTransponder extends AbstractMessageTransponder {
    ...
    protected void distributeEvent(Message message) {
        ...
        for (CanalEntry.Entry entry : entries) {
            ...
            distributeByAnnotation(destination, entry.getHeader().getSchemaName(), entry.getHeader().getTableName(), rowChange);
            distributeByImpl(destination, entry.getHeader().getSchemaName(), entry.getHeader().getTableName(), rowChange);
        }
    }
